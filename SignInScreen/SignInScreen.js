...
const SignInScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.inputsContainer}>
      ...
      />
      {showErrors && errors.email && <Text style={styles.errorText}>{errors.email}</Text>}
      ...
      />
      {showErrors && errors.password && <Text style={styles.errorText}>{errors.password}</Text>}

      <MyButton onPress={loginWithEmailAndPass} title="Login" />



      <Text style={styles.forgotPasswordText} onPress={forgotPassword}>Forgot Password</Text>
